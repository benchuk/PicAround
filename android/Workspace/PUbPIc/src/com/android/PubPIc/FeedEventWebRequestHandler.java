...
public class FeedEventWebRequestHandler
{
	...
	{
		ArrayList<FeedEventParams> listArray = new ArrayList<FeedEventParams>();
		JSONArray jsonArray;
		if (httpResponse != null)
		{
			...
			for (int i = 0; i < jsonArray.length(); ++i)
			{
				...
				// String id = null;
				FeedEventParams feedEventParams;
				try
				{
					feedEventParams = new FeedEventParams(rec.getString("UserId"), rec.getString("ThumbLink"), rec.getString("PlaceName"), rec.getString("EventName"), rec.getString("Description"));
				}
				catch (JSONException e)
				{
					Log.i(TAG, "Picup " + e.toString());
