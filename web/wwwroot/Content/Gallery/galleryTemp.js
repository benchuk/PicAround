$(function () {
    ...
    $('#content > img').hover(function () {
        ...
        $('<img/>').load(function () {
            ...
            */
            ...
            resize($theImage);
            $('#commentholder').empty();
            $('#commentholder').append($('<div/>').attr('id', 'comments').html($this.attr("description")));
            ...
            $('#panel').animate({ 'opacity': '1.0', 'height': '100%' }, speed, function () {
                /*
    ...
    */
    $('#wrapper > img').live('click', function () {
        ...
        //.stop()
        $("#panel").animate({ 'opacity': '0.0' }, speed, function () {
            $(this).css('height', '0px');
    ...
    which image is the corresponding neighbor.
    we know the index of the current picture (current),
    so we can easily get to the neighbor:
    */
    ...
    */
    function navigate($nextimage, dir) {
        ...
        */
        ...
        $('#commentholder').empty();
        $('#commentholder').append($('<div/>').attr('id', 'comments').html($nextimage.attr("description")));
    }
